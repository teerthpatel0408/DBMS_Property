CREATE USER MANTHAN IDENTIFIED BY MAN123;
...
GRANT CREATE SESSION TO MANTHAN;
...
GRANT dba TO MANTHAN;

GRANT SELECT, INSERT, UPDATE, DELETE ON SYS.USERS TO MANTHAN;
GRANT SELECT, INSERT, UPDATE, DELETE ON SYS.USER_PHONE TO MANTHAN;
GRANT SELECT, INSERT, UPDATE, DELETE ON SYS.LOGIN TO MANTHAN;
GRANT SELECT, INSERT, UPDATE, DELETE ON SYS.PROPERTY TO MANTHAN;
GRANT SELECT, INSERT, UPDATE, DELETE ON SYS.PROP_OWNED TO MANTHAN;
GRANT SELECT, INSERT, UPDATE, DELETE ON SYS.PROP_RENTED TO MANTHAN;

GRANT SELECT, UPDATE ON SYS.USERS TO MANTHAN;
GRANT SELECT, DELETE, INSERT, UPDATE ON SYS.USER_PHONE TO MANTHAN;
GRANT SELECT, UPDATE ON SYS.LOGIN TO MANTHAN;
GRANT SELECT, INSERT, UPDATE, DELETE ON SYS.PROPERTY TO MANTHAN;
GRANT SELECT, INSERT, UPDATE, DELETE ON SYS.PROP_OWNED TO MANTHAN;
GRANT SELECT, INSERT, UPDATE, DELETE ON SYS.PROP_RENTED TO MANTHAN;
...
GRANT EXECUTE ON SYS.GetPropertyRecord TO MANTHAN;
GRANT EXECUTE ON SYS.GetTenantDetails TO MANTHAN;
GRANT EXECUTE ON SYS.SearchPropertyForRent TO MANTHAN;
GRANT EXECUTE ON SYS.GetRentHistory TO MANTHAN;
GRANT EXECUTE ON SYS.InsertPropertyRecord TO MANTHAN;
GRANT EXECUTE ON SYS.CreateNewUser TO MANTHAN;
